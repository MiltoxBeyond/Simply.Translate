...
{
    /// <summary>
    /// ObservableDictionary - Originally ObservableConcurrentDictionary by Microsoft.  Adapted to allow for nesting 
    /// </summary>
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <typeparam name="TValue">The type of the value.</typeparam>
    /// <seealso cref="System.Collections.Generic.ICollection{System.Collections.Generic.KeyValuePair{TKey, TValue}}" />
        ...
        protected void NotifyObserversOfChange()
        {
            ...
            if (collectionHandler != null || propertyHandler != null)
            {
                _context.Post(s =>
                {
                    ...
                    NotifyPropertiesChanged("Count","Keys","Values");
                }, null);
            }
        }
